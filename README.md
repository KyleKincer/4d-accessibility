...
**Development preview.** The target is the entire application UI. Several control families and assistive-technology behaviors are still unfinished. Read the [support status](skills/4d-accessibility/references/STATUS.md) before adopting it. There is no production release yet.
