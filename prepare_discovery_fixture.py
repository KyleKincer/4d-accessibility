...
''')
    ...
    objects = {
        ...
        "Allowed": {"type": "checkbox", "text": "Send updates", "dataSource": "Form.allowed", "left": 20, "top": 130,
                    "width": 200, "height": 25, "events": ["onClick"]},
        "Email": {"type": "radio", "text": "Email", "dataSource": "Form.email", "radioGroup": "ContactChannel", "left": 240, "top": 130,
        ...
        "Phone": {"type": "radio", "text": "Phone", "dataSource": "Form.phone", "radioGroup": "ContactChannel", "left": 350, "top": 130,
                  "width": 100, "height": 25, "events": ["onClick"]},
        "Country": {"type": "dropdown", "dataSource": "AXBF_Choices", "left": 20, "top": 175, "width": 190, "height": 26, "events": ["onClick"]},
        ...
        "Save": {"type": "button", "text": "Save contact", "left": 20, "top": 280, "width": 160, "height": 28, "events": ["onClick"]},
